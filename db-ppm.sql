...
CREATE TABLE IF NOT EXISTS `db_ppm`.`treatment` (
  ...
  INDEX `fk_treat_allergic_idx` (`idAllergic` ASC),
...
*/
INSERT INTO `allergic-detail` (`id`,`idAllergic`,`idMedicine`) VALUES (1,1,'3');
INSERT INTO `allergic-detail` (`id`,`idAllergic`,`idMedicine`) VALUES (2,1,'1');
INSERT INTO `allergic-detail` (`id`,`idAllergic`,`idMedicine`) VALUES (3,2,'9');
...
*/
INSERT INTO `treatment` (`id`,`idPatient`,`idDoctor`,`date`,`idAllergic`,`file`,`prescription`) VALUES (1,1,2,'2017-02-10',2,'','nhiem trung mat');
INSERT INTO `treatment` (`id`,`idPatient`,`idDoctor`,`date`,`idAllergic`,`file`,`prescription`) VALUES (2,3,3,'2017-02-10',1,'','tim mach');
