...
-- -----------------------------------------------------
-- Table `db_ppm`.`allergic`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_ppm`.`allergic` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `note` VARCHAR(50) CHARACTER SET 'utf8' NULL DEFAULT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
AUTO_INCREMENT = 4
...
CREATE TABLE IF NOT EXISTS `db_ppm`.`allergic_detail` (
  `id` INT(11) NOT NULL,
  `idAllergic` INT(11) NOT NULL,
  `idMedicine` VARCHAR(45) CHARACTER SET 'utf8' NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_allergic_idx` (`idAllergic` ASC),
  CONSTRAINT `fk_allergic`
    FOREIGN KEY (`idAllergic`)
    REFERENCES `db_ppm`.`allergic` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
CREATE TABLE IF NOT EXISTS `db_ppm`.`treatment` (
  ...
  `prescription` VARCHAR(45) CHARACTER SET 'utf8' NOT NULL,
  PRIMARY KEY (`id`),
...
/*
-- Query: SELECT * FROM db_ppm.allergic
LIMIT 0, 1000

-- Date: 2017-03-07 16:27
*/
INSERT INTO `allergic` (`id`,`note`) VALUES (0,'non - allergic');
INSERT INTO `allergic` (`id`,`note`) VALUES (1,'allergic ');
INSERT INTO `allergic` (`id`,`note`) VALUES (2,'allergic');
...
*/
INSERT INTO `allergic_detail` (`id`,`idAllergic`,`idMedicine`) VALUES (1,1,'3');
INSERT INTO `allergic_detail` (`id`,`idAllergic`,`idMedicine`) VALUES (2,1,'1');
INSERT INTO `allergic_detail` (`id`,`idAllergic`,`idMedicine`) VALUES (3,2,'9');
